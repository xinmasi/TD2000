...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from VOTE_TITLE where VOTE_ID='$VOTE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update VOTE_TITLE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where VOTE_ID='$VOTE_ID'";
