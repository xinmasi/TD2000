...
<?
  if ($WEEK==6)
  {
      ...
      if($BEGIN_DAY < 0)
         $BEGIN_DAY=1;
?>
     <td class="TableData" width="50" align="center"><a href="javascript:user_list('user_list.php?YEAR=<?=$YEAR?>&MONTH=<?=$MONTH?>&BEGIN_DAY=<?=$BEGIN_DAY?>&END_DAY=<?=$DAY?>&USER_ID=<?=$USER_ID?>');"><?=sprintf(_("第%d周"),$WEEK_COUNT);?></a></td>
   </tr>
<?
  }
