...
<form action="update_diary.php"  method="post" name="form1" enctype="multipart/form-data">
...
//获得次大数
$query1 = "SELECT MAX(PERCENT) AS PERCENT_M from WORK_DETAIL where TYPE_FLAG='0' and WRITER='".$_SESSION["LOGIN_USER_ID"]."' and PLAN_ID='$PLAN_ID' and DETAIL_ID < '$DETAIL_ID'";
$cursor1= exequery(TD::conn(),$query1);
if($ROW1=mysql_fetch_array($cursor1))
   $PERCENT_MAX=$ROW1["PERCENT_M"];

$query1 = "SELECT MIN(PERCENT) AS PERCENT_M from WORK_DETAIL where TYPE_FLAG='0' and WRITER='".$_SESSION["LOGIN_USER_ID"]."' and PLAN_ID='$PLAN_ID' and DETAIL_ID > '$DETAIL_ID'";
$cursor1= exequery(TD::conn(),$query1);
if($ROW1=mysql_fetch_array($cursor1))
