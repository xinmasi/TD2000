...
?>
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        <!--由于原来的没有给方法传参数，所以此文件修改，增加需要的参数-->
        <a href="javascript:;" class="orgAdd" onClick="SelectDeptSingle('','TO_ID','TO_NAME')"><?=_("选择")?></a>
      </td>
    </tr>
    <tr>
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="SelectUserSingle('96','','TO_ID3', 'TO_NAME3')"><?=_("添加")?></a>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="SelectUserSingle('96','','SECRET_TO_ID', 'SECRET_TO_NAME')"><?=_("添加")?></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="TableData"><?=_("发布人(部门)：")?></td>
      <td class="TableData">
      	<input type="hidden" name="NEWER_DEPT_ID" value="">
        <input type="text" name="NEWER_DEPT_NAME" size="20" class="BigStatic" readonly>&nbsp;
        <a href="javascript:;" class="orgAdd" onClick="SelectDeptSingle('','NEWER_DEPT_ID', 'NEWER_DEPT_NAME')"><?=_("添加")?></a>
      </td>
    </tr>  
    <tr>
