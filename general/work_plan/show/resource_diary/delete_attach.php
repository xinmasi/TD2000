...
<?
	...
	$query="select * from WRESOURCE_DETAIL where AUTO_DETAIL='$DETAIL_ID1'";
	...
	if($ATTACHMENT_NAME!="")
	{
		...
		$query="update WRESOURCE_DETAIL set ATTACHMENT_ID='$ATTACHMENT_ID_NEW',ATTACHMENT_NAME='$ATTACHMENT_NAME_NEW' where AUTO_DETAIL='$DETAIL_ID1'";
		exequery(TD::conn(),$query);
	}
	if($FLAG==1)
	   header("location: edit_resource.php?DETAIL_ID=$DETAIL_ID1&PLAN_ID=$PLAN_ID");
	else
