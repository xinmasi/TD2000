...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update MEETING set ATTACHMENT_ID='$ATTACHMENT_ID_NEW',ATTACHMENT_NAME='$ATTACHMENT_NAME_NEW' where M_ID='$M_ID'";
   exequery(TD::conn(),$query);
}

header("location: new.php?M_ID=$M_ID&CUR_PAGE=$CUR_PAGE");
?>
