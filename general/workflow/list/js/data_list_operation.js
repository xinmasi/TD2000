...
//工作删除
function delete_run(RUN_ID,FLOW_ID,BEGIN_DEPT,PRCS_ID,FLOW_PRCS)
{
    var msg=td_lang.general.workflow.msg_6;//"确认要删除所选工作吗？"
    if(window.confirm(msg))
    {
       jQuery.get("/module/workflow/engine/delete_work.php",{"RUN_ID_STR":RUN_ID,"FLOW_ID":FLOW_ID,"BEGIN_DEPT":BEGIN_DEPT,"PRCS_ID":PRCS_ID,"FLOW_PRCS":FLOW_PRCS},function(data)
       {
           jQuery("#gridTable").jqGrid('setGridParam', { serializeGridData : function(e){ e.connstatus = 1;  return e;} }).trigger('reloadGrid');
       });
    }
