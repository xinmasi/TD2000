...
if($s_user_id != "")
{
    ...
    {
        $query = "UPDATE address SET SHARE_USER='',ADD_START='',ADD_END='' WHERE ADD_ID='$add_id'";
        exequery(TD::conn(), $query);

        $query = "UPDATE ADDRESS_GROUP SET SHARE_USER_ID='',SHARE_GROUP_ID='' WHERE GROUP_ID='$group_id'";
        exequery(TD::conn(), $query);
    }
...
<script>
    ...
    location="../index.php?GETUPID=<?=$add_id?>";
</script>
</body>
</html>
