...
?>
    <div class="new_f" style="height:100%;">
        <form enctype="multipart/form-data" action="edit_update.php"  method="post" name="form1" id="form1" class="form-horizontal" onSubmit="return CheckForm();" style="margin: 0px;height:100%;">
            <div class="left" style="width: 220px;height:100%;">
                <div id="img">
            ...
            <div class="right" id="show_right" style="height:92%;width: 780px;">
                <div id="name">
                ...
                <div id="show_share" style="display:none;width:500px;clear:both; padding-top:10px; float:left;">
                    ...
                    <input type="hidden" name="where_str" value="<?=$where_str?>">
                    <input type="hidden" name="attachment_id_old" value="<?=$ATTACHMENT_ID?>">
                    <input type="hidden" name="attachment_name_old" value="<?=$ATTACHMENT_NAME?>">
            </div>
                <div id="bts" style="width:780px;left:500px;height: 6%;">
                    <button type="submit" class="btn btn-primary" id="bc" style="margin-right:20px;">保存</button>
                <?
                if($from == '1')
                {
                ?>
                    <button type="button" class="btn" id="fh" onClick="self.close();">关闭</button>
                <?
                }
                else
                {
                ?>
                    <button type="button" class="btn" id="fh" onClick="location='search_submit.php?start=<?=$start?><?=$where_str2?>'">返回</button>
                <?
                }
                ?>
                </div>
