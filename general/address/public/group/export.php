...
if($TYPE==0) //Foxmail
{
   ...
   if(MYOA_IS_UN == 1)
      ...
      $OUTPUT_HEAD = _("姓名").","._("职务").","._("昵称").","._("电子邮件").","._("手机").","._("小灵通").",QQ,MSN,"._("性别").","._("生日").","._("配偶").","._("子女").","._("家庭邮编").","._("家庭住址").","._("家庭电话").","._("单位名称").","._("单位邮编").","._("单位地址").","._("工作电话").","._("工作传真").","._("备注").",".$FIELDNAME;
}
else //outlook
{
   //echo $l_outlookStr.$FIELDNAME;
   if(MYOA_IS_UN == 1)
      $OUTPUT_HEAD = "NAME,MINISTRATION,NICK_NAME,EMAIL,MOBIL_NO,TEL_NO,QQ,MSN,SEX,BIRTHDAY,MATE,CHILD,HOME_POSTCODE,HOME_ADD,HOME_PHONE,DEPT_NAME,DEPT_POSTCODE,DEPT_ADD,OFFICE_PHONE,COMPONY_FAX,NOTES,".$FIELDNAME;
   else
      $OUTPUT_HEAD = _("姓名").","._("职务").","._("昵称").","._("电子邮件").","._("手机").","._("小灵通").",QQ,MSN,"._("性别").","._("生日").","._("配偶").","._("子女").","._("家庭邮编").","._("家庭住址").","._("家庭电话").","._("单位名称").","._("单位邮编").","._("单位地址").","._("工作电话").","._("工作传真").","._("备注").",".$FIELDNAME;
