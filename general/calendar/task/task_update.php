...
for($I=0;$I< count($TASK_ID_ARRAY);$I++)
{
	if ($TASK_ID_ARRAY[$I]=='')
		continue;
	$query="UPDATE TASK SET TASK_NO='$TASK_NO',TASK_TYPE='$TASK_TYPE',TASK_STATUS='$TASK_STATUS',COLOR='$COLOR',IMPORTANT='$IMPORTANT',SUBJECT='$SUBJECT',EDIT_TIME='$EDIT_TIME',BEGIN_DATE='$BEGIN_DATE',END_DATE='$END_DATE',CONTENT='$CONTENT',RATE='$RATE',FINISH_TIME='$FINISH_TIME',TOTAL_TIME='$TOTAL_TIME',USE_TIME='$USE_TIME',CAL_ID='$CAL_ID',ADD_TIME='$ADD_TIME',TASK_NO='$TASK_NO' WHERE TASK_ID = '$TASK_ID_ARRAY[$I]' ";
