...
$query="INSERT INTO `TASK`(`USER_ID` , `TASK_TYPE` , `TASK_STATUS` , `COLOR` , `IMPORTANT` , `SUBJECT` , `EDIT_TIME` , `BEGIN_DATE` , `END_DATE` , `CONTENT` , `RATE` , `FINISH_TIME` , `TOTAL_TIME` , `USE_TIME` , `CAL_ID`,`TASK_NO` )
VALUES ('".$_SESSION["LOGIN_USER_ID"]."', '$TASK_TYPE', '$TASK_STATUS', '$COLOR', '$IMPORTANT', '$SUBJECT', '$CUR_TIME', '$BEGIN_DATE', '$END_DATE', '$CONTENT', '$RATE', '$FINISH_TIME', '$TOTAL_TIME', '$USE_TIME', '$CAL_ID','$TASK_NO');";
