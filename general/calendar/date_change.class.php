...
class Lunar {
	...
	function convertSolarToLunar($DATE_TIME){
		...
		if($year==$this->MIN_YEAR&&$month<=2&&$date<=9){
			return array(1891,_("正月"),_("初一"),_("辛卯"),1,1,_("兔"));
		}
	...
	*/
	...
	function getLunarYearName($year){
		 $sky = array(_("庚"),_("辛"),_("壬"),_("癸"),_("甲"),_("乙"),_("丙"),_("丁"),_("戊"),_("己"));
		 $earth = array(_("申"),_("酉"),_("戌"),_("亥"),_("子"),_("丑"),_("寅"),_("卯"),_("辰"),_("巳"),_("午"),_("未"));
		 $year = $year.'';
	...
	function getYearZodiac($year){
		 $zodiac = array(_("猴"),_("鸡"),_("狗"),_("猪"),_("鼠"),_("牛"),_("虎"),_("兔"),_("龙"),_("蛇"),_("马"),_("羊"));
	...
	function getLunarByBetween($year,$between){
		...
		$m='';
		if($between==0){
			array_push($lunarArray, $year,_("正月"),_("初一"));
			$t = 1;
			$e = 1;
		}else{
			...
			$m = ($leapMonth!=0&&$t==$leapMonth+1)?(_("闰").$this->getCapitalNum($t- 1,true)):$this->getCapitalNum(($leapMonth!=0&&$leapMonth+1<$t?($t-1):$t),true);
	...
	function getCapitalNum($num,$isMonth){
		...
		$dateHash=array('0'=>'','1'=>_("一"),'2'=>_("二"),'3'=>_("三"),'4'=>_("四"),'5'=>_("五"),'6'=>_("六"),'7'=>_("七"),'8'=>_("八"),'9'=>_("九"),'10'=>_("十 "));
		$monthHash=array('0'=>'','1'=>_("正月"),'2'=>_("二月"),'3'=>_("三月"),'4'=>_("四月"),'5'=>_("五月"),'6'=>_("六月"),'7'=>_("七月"),'8'=>_("八月"),'9'=>_("九月"),'10'=>_("十月"),'11'=>_("十一月"),'12'=>_("腊月"));
		$res='';
		if($isMonth){
			$res = $monthHash[$num];
		}else{
			if($num<=10){
				$MSG1 = sprintf(_("初%s"), $dateHash[$num]);
				$res = $MSG1;
			}else if($num>10&&$num<20){
				$MSG2 = sprintf(_("十%s"), $dateHash[$num-10]);
				$res = $MSG2;
			}else if($num==20){
				$res = _("二十");
			}else if($num>20&&$num<30){
				$MSG3 = sprintf(_("廿%s"), $dateHash[$num-20]);
				$res = $MSG3;
			}else if($num==30){
				$res = _("三十");
			}
