...
if($POST_PRIV=="1")
{
   ...
   <tr class="TableData" align="center">
     ...
     <td nowrap><a href="/general/diary/show/info/user_diary.php?USER_ID='.$USER_ID.'&DEPT_ID=0" target='.$target.'>'.$USER_NAME.'</a></td>
   </tr>';
   }
   $user_out.='</table>';
...
$MENU_LEFT[count($MENU_LEFT)] = array("text" => _("员工日志查询"), "href" => "user_query.php", "onclick" => "", "target" => $target, "title" => "", "img" => "", "module" => "", "module_style" => "");

$MENU_LEFT[count($MENU_LEFT)] = array("text" => _("最新10篇员工日志"), "href" => "diary_body.php", "onclick" => "", "target" => $target, "title" => "", "img" => "", "module" => "", "module_style" => "");
