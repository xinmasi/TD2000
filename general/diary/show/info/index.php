...
{
?>
   <link rel="stylesheet" type="text/css" href="<?=MYOA_JS_SERVER?>/static/theme/<?=$_SESSION["LOGIN_THEME"]?>/un_<?=MYOA_LANG_COOKIE?>.css" />
<?
}
?>
...
#container_1 ul.dynatree-container ul{
    padding: 0 0 0 13px;
}
</style>
<script>
...
<table style="width:200px;position:absolute;top:0px;left:0px;">
   <tr>
      <td id="left">
...
?>
         <div class="head" style="display:none;"><a href="user_query.php" class="header" target="user_diary"><?=_("员工日志查询")?></a></div>
         <table class="BlockBottom">
            <tr>
               <td class="left"></td>
               <td class="center">
                  <a href="diary_body.php" class="header" target="user_diary"><?=_("最新员工日志")?></a>
               </td>
               <td class="right"></td>
            </tr>
         </table>
...
<div style="position:absolute;left:200px;right:0px;height:100%">
<iframe id="user_diary" name="user_diary" src="blank.php" frameborder="0" style="height:100%;width:100%"></iframe>
</div>
</body>
</html>