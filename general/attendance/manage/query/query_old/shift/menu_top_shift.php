...
$MENU_TOP=array(
   array("text" => _("轮班考勤统计"), "href" => "index1.php?DATE1=$DATE1&DATE2=$DATE2&DUTY_TYPE1=$DUTY_TYPE1&DEPARTMENT1=$DEPARTMENT1", "target" => "menu_main", "title" => "", "img" => MYOA_STATIC_SERVER."/static/images/menu/attendance.gif"),
   ...
   array("text" => _("返回"), "href" => "../index2.php", "target" =>"_parent", "title" => "", "img" => ""),
);
