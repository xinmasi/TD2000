...
function delete_mail()
{
  ...
  if(delete_str=="")
  {
     alert("<?=_("要删除查岗质询信息，请至少选择其中一条。")?>");
     return;
  }

  msg='<?=_("确认要删除该项查岗质询信息吗？")?>';
  if(window.confirm(msg))
  {
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/notify_open.gif" align="absmiddle"><span class="big3"> <?=_("管理查岗质询")?></span>&nbsp;
    </td>
<?
if($TOTAL_ITEMS>0)
{
