...
<body class="bodycolor attendance">
  <table class="table table-bordered" style="margin-left: 50px;">
      <thead>
            <tr class="">
                <th nowrap align="center"><?=_("缺岗人")?></th>
                <th nowrap align="center"><?=_("查岗人")?></th>
                <th nowrap align="center"><?=_("查岗时间")?></th>
                <th nowrap align="center"><?=_("缺岗人说明时间")?></th>
            </tr>
      </thead>
...
<h5 class="attendance-title"><span class="big3"> <?=_("查岗质询查询结果")?></span></h5><br>
