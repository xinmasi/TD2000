...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/calendar.gif" align="absMiddle" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> <?=_("说明情况")?></span>
    </td>
  </tr>
</table>
...
<br>
 <table class="TableBlock"  width="400" align="center">
  <form action="remark.php?connstatus=1"  method="post" name="form1" onsubmit="return CheckForm();">
    ...
    <tr>
      <td class="TableData">
        <textarea name="CONTENT" cols="50" rows="7" class="BigInput"><?=$CONTENT?></textarea>
      </td>
    </tr>
