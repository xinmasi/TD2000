...
//                             ITask.refreshNumber("perf", -1);
        ...
        */
		...
		createTask : function(task, top) {
            ...
            $("#no-task-msg").hide();
            var li = $('<li class="task-item"><div class="drag"></div><div class="fold"></div><div class="star"></div><div class="creator"></div><div class="operator"></div><div class="title"><a href="#"></a></div><div class="prcs"><b></b></div><div class="date"></div><div class="operation"></div></li>');
            var $opration = $('<ul></ul>');      
