...
<html>
    ...
    <body onload="window.print('Print');">
        <div class ="print">
            <h2 align="center"><?= $s_name ?><?= _("项目报表") ?></h2>
            <p align="center"><?= _("负责人") ?>:&nbsp<?= $s_leader ?></p>
            <div class="message">
                <h3 style="text-align:left; margin:0px"><?= _("基本信息") ?></h3>
                <ul style="margin:8px">
                    <li><?= _("项目编号") ?>：&nbsp;<?= $s_num ?>;</li>
                    <li><?= _("项目类别") ?>：&nbsp;<?= $s_type ?>;</li>
                ...
                <hr>
                <h3 style="text-align:left; margin:0px"><?= _("干系人") ?></h3>
                ...
                <hr>
                <h3 style="text-align:left; margin:0px"><?= _("总预算资金") ?></h3>
                <ul style="margin:8px">
                    <li><?= number_format($f_cost_money, 2) ?>&nbsp;<?= _("元") ?></li>
                </ul>

                <hr>
                <h3 style="text-align:left; margin:0px"><?= _("任务信息") ?></h3>
                <?php
