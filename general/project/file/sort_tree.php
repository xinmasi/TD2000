...
$query = "select SORT_ID,SORT_NAME,VIEW_USER FROM PROJ_FILE_SORT WHERE PROJ_ID='$PROJ_ID' order by SORT_NO,SORT_NAME";
$cursor= exequery(TD::conn(),$query);
while($ROW=mysql_fetch_array($cursor))
{
    ...
    {   
      ...
      $url = "folder.php?PROJ_ID=".$PROJ_ID."&SORT_ID=".$SORT_ID;
