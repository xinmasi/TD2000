...
$num = count($tempArray);
for ($i=0; $i < $num; $i++) {
	$TASK_SORT += $tempArray[$i] * 10000000/pow(10,$i);
}

$query = "insert into PROJ_TASK (TAST_CONSTRAIN,PROJ_ID,TASK_SORT,TASK_NO, TASK_NAME, TASK_DESCRIPTION, TASK_USER, TASK_MILESTONE, TASK_START_TIME, TASK_END_TIME, TASK_TIME, TASK_LEVEL, PARENT_TASK, PRE_TASK, TASK_PERCENT_COMPLETE,REMARK , FLOW_ID_STR,CAL_ID) VALUES ('$c','$PROJ_ID','$TASK_SORT', '$TASK_NO', '$TASK_NAME', '$TASK_DESCRIPTION', '$TASK_USER', '$TASK_MILESTONE', '$TASK_START_TIME', '$TASK_END_TIME', '$TASK_TIME', '$TASK_LEVEL', '$PARENT_TASK', '$PRE_TASK', '$TASK_PERCENT_COMPLETE','$REMARK' ,'$FLOW_ID_STR','$CAL_ID')";
