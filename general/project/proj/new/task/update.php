...
$query = "update PROJ_TASK SET CAL_ID='$CAL_ID',TASK_SORT='$TASK_SORT',TASK_NO='$TASK_NO', TASK_NAME='$TASK_NAME', TASK_DESCRIPTION='$TASK_DESCRIPTION', TASK_USER='$TASK_USER', TASK_MILESTONE='$TASK_MILESTONE', TASK_START_TIME='$TASK_START_TIME', TASK_END_TIME='$TASK_END_TIME', TASK_TIME='$TASK_TIME', TASK_LEVEL='$TASK_LEVEL',PARENT_TASK='$PARENT_TASK',PRE_TASK='$PRE_TASK',REMARK='$REMARK',FLOW_ID_STR='$FLOW_ID_STR',TAST_CONSTRAIN='$CONSTRAIN' WHERE TASK_ID='$TASK_ID'";
