...
$MSG1 = sprintf(_("%s人"), '<font color="red"><b>'.$USER_COUNT.'</b></font>');
?>

<span align="left" class="big1" ><b><?=_("在线人员：")?></b></span><?=$MSG1?><br><br> 
...
?>
    <a href="javascript:parent.chat_input.say_to('<?=$ARRAY_ID[$I]?>','<?=$ARRAY_NAME[$I]?>');" title="<?=$USERNAME.$USERIP?>">[<?=$ARRAY_NAME[$I]?>]</a><br>
<?
}
