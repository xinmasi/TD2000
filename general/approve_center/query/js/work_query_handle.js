...
function getSearchStr(){
	...
	searchStr +="&leave_user_id="+ jQuery('#LEAVE_QUERY_TYPE').find('option:selected').val();//离职人员
	searchStr +="&search_begin_dept="+ jQuery.trim(jQuery('#search_begin_dept').val());//发起人的部门
	return 	searchStr;
}
