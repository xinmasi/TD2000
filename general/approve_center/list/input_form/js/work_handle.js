...
function ReNameFile(TYPE, PARA, ATTACHMENT_ID, ATTACHMENT_NAME)
{
    ...
    URL="rename_file.php?ATTACHMENT_ID="+ATTACHMENT_ID+"&ATTACHMENT_NAME="+ATTACHMENT_NAME+"&RUN_ID="+RUN_ID+"&FLOW_ID="+FLOW_ID+"&TYPE="+TYPE+"&PARA="+PARA+"&PRCS_ID="+PRCS_ID+"&FLOW_PRCS="+FLOW_PRCS;
