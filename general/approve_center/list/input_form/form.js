...
function list_data_picker(obj,table, field, fieldName, dataQuery)
{
	...
	var URL="/general/approve_center/list/input_form/data_picker.php?dataSrc="+dataSrc+"&dataField="+field+"&dataFieldName="+fieldName+"&dataQuery="+dataQuery+"&row_id="+row_id+"&all_id="+all_id_str+"&LIST_VIEW=LIST_VIEW";
	var openWidth = 800;
    var openHeight = 450;
    var loc_x = (screen.availWidth - openWidth) / 2;
    var loc_y = (screen.availHeight - openHeight) / 2;
