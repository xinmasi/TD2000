jQuery(document).ready(function(){ 
    ...
    jQuery('#do_destroy').click(function(){
        var url = "/general/approve_center/destroy/data/dodestroy.php";
    ...
    jQuery('#do_restoration').click(function(){
        var url = "/general/approve_center/destroy/data/dorestoration.php";
        var run_id_str = jQuery("#gridTable").jqGrid('getGridParam', 'selarrrow');
...
function view_graph(FLOW_ID)
{
    ...
    window.open("/general/approve_center/flow_view.php?FLOW_ID="+FLOW_ID,"","status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=1000,height=550,left="+myleft+",top=50");
}
