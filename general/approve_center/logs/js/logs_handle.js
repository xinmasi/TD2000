...
function doDeleteBatch(){
    var url = "/general/approve_center/logs/data/dodelete.php";
    ...
    if((del_flow_id=="all"||del_flow_id=="")&&del_run_id==""&&del_user_id==""&&del_run_name==""&&del_begin_time==""&&del_end_time==del_end_time&&del_log_type==""&&del_ip=="")
    {
     	...
     	if(window.prompt(msg,"") == "OK")
        {
            ...
            ({		   
                url: url,
                data: {'del_flow_id':del_flow_id,'del_run_name':del_run_name,'del_run_id':del_run_id,'del_user_id':del_user_id,'del_begin_time':del_begin_time,'del_end_time':del_end_time,'del_log_type':del_log_type,'del_ip':del_ip},
                type: "POST",
                async: true,
...
function doExportBatch(){
    var url = "/general/approve_center/logs/data/doexport.php";
