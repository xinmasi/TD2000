...
<table class="TableBlock" width="550" align="center">
  <form enctype="multipart/form-data"  name="form1" onsubmit="return checkForm();">
<?
...
?>
    <tr>
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="SelectUser('24','','TO_ID', 'TO_NAME')"><?=_("添加")?></a>
...
?>
    ...
    <tr>
      ...
      <td class="TableData">
        <input type="text" id="start_time" name="SEND_TIME_MIN" size="12" maxlength="10" class="BigInput" value="" onClick="WdatePicker()"/> &nbsp;<?=_("至")?>&nbsp;         
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        <input type="radio" name="OPERATION" id="OPERATION3" value="3"><label for="OPERATION3"><?=_("导出")?>excel<?=_("文件")?></label>
      </td>
    </tr>
