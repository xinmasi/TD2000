...
$query = "SELECT BOOK_ID,BOOK_NO,DEPT,OPEN,BOOK_NAME from BOOK_INFO ".$WHERE_STR." and ((BOOK_NO like '%$BOOK_NO%') or (BOOK_NAME like '%$BOOK_NO%')) order by BOOK_NO limit 0,50";
