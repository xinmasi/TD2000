...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/vehicle.gif" width="24" height="24"><span class="big3"><?=_("冲突申请的详细信息")?></span><br>
    </td>
  </tr>
</table>
...
<table class="TableBlock" width="100%">
  ...
  <tr class="TableLine1">
      ...
      <td nowrap align="left" class="TableData"><?=$VU_DRIVER?></td>
  </tr>
  <tr class="TableLine2">
  ...
  <tr class="TableLine2">
      ...
      <td nowrap align="left" class="TableData"><?=$VU_SUITE?></td>
  </tr>
  <tr class="TableLine1">
