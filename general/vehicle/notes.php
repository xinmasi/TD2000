...
$query="select VU_MILEAGE from VEHICLE_USAGE where VU_ID='$VU_ID'";
...
<table class="TableBlock" align="center" width="90%">
    <tr>
      ...
      <td class="TableData">
        <input type="text" name="VU_MILEAGE_TRUE" size="10" class="SmallInput" value="<?=$VU_MILEAGE?>">&nbsp;<?=_("公里")?></td>
	 </tr>
	 <tr>
      <td nowrap class="TableContent" width="20%"> <?=_("费用：")?></td>
      <td class="TableData">
        <input type="text" name="VU_PARKING_FEES" size="10" class="SmallInput" value="">&nbsp;<?=_("元(包括停车费,高速费,过桥费,加油费等)")?></td>	  	
    </tr>
