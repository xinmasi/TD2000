...
if(find_id($MANAGERS,$_SESSION["LOGIN_USER_ID"]))
   ...
   $query = "SELECT * from VEHICLE where (DEPT_RANGE = 'ALL_DEPT' or find_in_set('".$_SESSION["LOGIN_DEPT_ID"]."',DEPT_RANGE) or find_in_set('".$_SESSION["LOGIN_USER_ID"]."',USER_RANGE) or DEPT_RANGE='' and USER_RANGE='') order by V_NUM";
...
?>
    ...
    <tr>
      ...
      <td class="TableData">
        <input type="text" name="VU_REQUEST_DATE_MIN" size="12" maxlength="10" class="BigInput" value="" onClick="WdatePicker()">
        <?=_("至")?>
        <input type="text" name="VU_REQUEST_DATE_MAX" size="12" maxlength="10" class="BigInput" value="" onClick="WdatePicker()">
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        <input type="text" name="TO_NAME1" size="20" maxlength="100"   >&nbsp;
        <a href="javascript:;" class="orgAdd" onClick="SelectUserSingle('90','','TO_ID1', 'TO_NAME1')"><?=_("选择")?></a>
      </td>
    </tr>
    <tr>
