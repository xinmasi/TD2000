...
<form enctype="multipart/form-data" action="<?if ($FLAG=="1") echo "add_1";else echo "add_no"?>.php" method="post" name="form1">
<? 
if ($FLAG=="1")
{
...
?>
    ...
    <tr>
      <td nowrap class="TableData" width="80"> <?=_("随行人员：")?></td>
...
?>
    ...
    <tr>
      <td nowrap class="TableData" width="80"> <?=_("在线调度")?><br><?=_("人员：")?></td>
      <td class="TableData">
<?
$POSTFIX = _("，");
$ONLINE_USER_NAME="";
...
?>
     ...
     <td nowrap class="TableData" width="80"> <?=_("备选调度员：")?></td>
     <td class="TableData">
...
?>
    ...
    <tr>
      <td nowrap class="TableData" width="80"> <?=_("提醒调度员：")?></td>
      <td class="TableData" colspan="3">
...
?>&nbsp;&nbsp;说明：设置是否通知调度员审批
    ...
    <tr>
        <td nowrap class="TableData" width="80"><?=_("提醒备选调度员：")?></td>
        <td class="TableData" colspan="3">
            <?if (find_id($SMS3_REMIND, 9)){?>
  ...
  <tr>
      <td nowrap class="TableData" width="80"><?=_("通知申请人：")?></td>
      <td class="TableData" colspan="3">
...
{
?>
        <input type="button" value="<?=_("返回")?>" class="BigButton" onClick="location='/general/vehicle/query.php?VU_STATUS=<?=$VU_STATUS?>&DMER_STATUS=<?=$DMER_STATUS?>'">
<?
}elseif($VU_ID!="")
{
?>
