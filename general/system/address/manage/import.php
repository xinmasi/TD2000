...
function CheckForm()
{
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
    <tr>
      <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/sys_config.gif" align="absmiddle"><span class="big3"> <?=_("导入Excel通讯簿")?></span><br>
      </td>
    </tr>
  </table>
...
else
{
   $title=array(_("姓名")=>"PSN_NAME",_("名")=>"FIRST_NAME",_("姓")=>"LAST_NAME",_("性别")=>"SEX",_("昵称")=>"NICK_NAME",_("电子邮件地址")=>"EMAIL",_("电子邮件")=>"EMAIL",
             _("住宅所在街道")=>"ADD_HOME",_("家庭所在街道")=>"ADD_HOME",_("住宅地址 街道")=>"ADD_HOME",_("家庭电话1")=>"TEL_NO_HOME",_("住宅电话")=>"TEL_NO_HOME",_("家庭电话")=>"TEL_NO_HOME",
             ...
             _("公司所在地邮政编码")=>"POST_NO_DEPT",_("公司所在地的邮政编码")=>"POST_NO_DEPT",_("商务地址 邮政编码")=>"POST_NO_DEPT",_("公司所在街道")=>"ADD_DEPT",_("商务地址 街道")=>"ADD_DEPT",
             _("职位")=>"MINISTRATION",_("职务")=>"MINISTRATION",_("办公电话1")=>"TEL_NO_DEPT",_("业务电话")=>"TEL_NO_DEPT",_("商务电话")=>"TEL_NO_DEPT",_("工作电话")=>"TEL_NO_DEPT",
             _("公司传真")=>"FAX_NO_DEPT",_("业务传真")=>"FAX_NO_DEPT",_("工作传真")=>"FAX_NO_DEPT",_("配偶")=>"MATE",_("子女")=>"CHILD",_("公司")=>"DEPT_NAME",_("附注")=>"NOTES",
   );
