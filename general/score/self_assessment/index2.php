...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/score.gif" WIDTH="22" HEIGHT="22" align="absmiddle"><span class="big3">&nbsp;<?=_("已自评考核任务列表")?></span>
    </td>
  </tr>
</table><br>
<?
...
<table border="0" width="80%" cellspacing="0" cellpadding="3" class="TableList">
	...
	<tr class="<?=$TableLine?>">
		...
		<td align="center"><?=("已自评")?></td>
		<td align="center"><a href="detail.php?FLOW_ID=<?=$FLOW_ID ?>&GROUP_ID=<?=$GROUP_ID?>"> <?=("详细信息")?></a></td>
	</tr>
<?		 				
		 		}
		 		else
