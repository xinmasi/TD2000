...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/infofind.gif" align="absmiddle"><span class="big3"> <?=_("电话区号查询")?></span>
    </td>
  </tr>
</table>
...
<div align="center">
  ...
  <table class="TableBlock" width="450" align="center">
    <tr class="TableHeader">
      <td nowrap align="center" colspan="5"><b><?=_("中国")?> - <?=_("省(直辖市/自治区")?>)</b></td>
    </tr>
