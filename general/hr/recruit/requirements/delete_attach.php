...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_RECRUIT_REQUIREMENTS where REQUIREMENTS_ID='$REQUIREMENTS_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_RECRUIT_REQUIREMENTS set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where REQUIREMENTS_ID='$REQUIREMENTS_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?REQUIREMENTS_ID=$REQUIREMENTS_ID&?start=$start");
?>
