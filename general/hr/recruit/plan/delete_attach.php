...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_RECRUIT_PLAN where PLAN_ID='$PLAN_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_RECRUIT_PLAN set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where PLAN_ID='$PLAN_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?PLAN_ID=$PLAN_ID&?start=$start");
?>
