...
<table class="TableBlock" width="600" align="center">
   ...
   <tr>
      ...
      <td class="TableData" colspan=3>
        <input type="text" id="start_time1" name="START_DATE1" size="13" maxlength="10" class="BigInput" value="<?=$START_DATE1?>" onClick="WdatePicker()"/>
        <?=_("至")?>
        <input type="text" name="END_DATE1" size="13" maxlength="10" class="BigInput" value="<?=$END_DATE1?>" onClick="WdatePicker({minDate:'#F{$dp.$D(\'start_time1\')}'})"/>       
      </td>
    </tr>
    <tr>
      <td nowrap class="TableData"> <?=_("招聘结束日期：")?></td>
      <td class="TableData" colspan=3>
        <input type="text" id="start_time2" name="START_DATE2" size="13" maxlength="10" class="BigInput" value="<?=$START_DATE2?>" onClick="WdatePicker()"/>
        <?=_("至")?>
        <input type="text" name="END_DATE2" size="13" maxlength="10" class="BigInput" value="<?=$END_DATE2?>" onClick="WdatePicker({minDate:'#F{$dp.$D(\'start_time2\')}'})"/>       
      </td>
    </tr>
