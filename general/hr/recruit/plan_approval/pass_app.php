...
<?
$query = "SELECT * from HR_RECRUIT_PLAN WHERE APPROVE_PERSON='".$_SESSION["LOGIN_USER_ID"]."' and PLAN_STATUS='1'";
$cursor=exequery(TD::conn(),$query);
$STAFF_COUNT = mysql_num_rows($cursor);

$query = "SELECT * from HR_RECRUIT_PLAN WHERE APPROVE_PERSON='".$_SESSION["LOGIN_USER_ID"]."' and PLAN_STATUS='1' ORDER BY PLAN_ID desc limit $start,$PAGE_SIZE";
$cursor=exequery(TD::conn(),$query);
...
<body class="bodycolor">
  ...
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/infofind.gif" align="absMiddle"><span class="big3"><?=_("已批准招聘计划")?></span><br>
    	</td>
