...
<table class="TableBlock" width="60%" align="center">
   <tr>
    	...
    	<td class="TableData"  width="180" name="PLAN_NAME"><?=$PLAN_NAME?></td>
   ...
   <tr>
      ...
      <td class="TableData" colspan=3 style="word-break:break-all;"><?=$RECRUIT_DIRECTION?></td>
   </tr> 
   <tr>
      <td nowrap class="TableData"><?=_("招聘备注：")?></td>
      <td class="TableData" colspan=3 style="word-break:break-all;"><?=$RECRUIT_REMARK?></td>
   </tr> 
   <tr>
...
-->
   ...
   <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
        ...
        <input type="submit" value="<?=_("批准")?>" class="BigButton">&nbsp;&nbsp;
