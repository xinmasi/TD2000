...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_RECRUIT_POOL where EXPERT_ID='$EXPERT_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_RECRUIT_POOL set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where EXPERT_ID='$EXPERT_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?EXPERT_ID=$EXPERT_ID&?start=$start");
?>
