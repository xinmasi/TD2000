...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small" >
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/send.gif" width="18" HEIGHT="18"><span class="big3"> <?=_("设置公开字段")?></span>
    	<span class="small1"> <?=_("注意：字段设置为公开后，在查看在线人员列表时，点击姓名即可看到，请谨慎设置！")?></span>
    </td>
  </tr>
</table>
<?
...
$SYS_PARA_ARRAY = get_sys_para("HRMS_OPEN_FIELDS");
$HRMS_OPEN_FIELDS=$SYS_PARA_ARRAY["HRMS_OPEN_FIELDS"];
