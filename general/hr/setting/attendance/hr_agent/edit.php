...
<?
$query = "select MANAGER_ID,MANAGERS,DEPT_ID_STR from ATTEND_LEAVE_MANAGER where MANAGER_ID='$MANAGER_ID'";
...
?>
<h5 class="attendance-title"><?=_("编辑代考勤规则")?></h5>
<br>
<form action="update.php"  method="post" name="form1" onSubmit="return CheckForm();"> 
  <table class="table table-middle table-bordered" align="center" >
   ...
   <tr>
    <td nowrap class="TableData"><?=_("代考勤人员：")?></td>
