...
<h5 class="attendance-title"><?=_("代考勤规则新建")?></h5><br>
    ...
    <table class="table table-middle table-bordered" align="center">
        ...
        <tr>
            <td nowrap  class="" colspan="2" style="text-align: center;">
                <input type="submit" value="<?=_("添加代考勤规则")?>" class="btn btn-primary">&nbsp;&nbsp;
            </td>
        </tr>
    </table>
</form>
...
<br>
<h5 class="attendance-title"><?=_("代考勤规则管理")?></h5><br>

<?
$I = 0;
$query = "select MANAGER_ID,DEPT_ID_STR,MANAGERS from ATTEND_LEAVE_MANAGER order by MANAGER_ID";
...
while($ROW=mysql_fetch_array($cursor))
{
    ...
    <table class="table table-bordered" align="center">
        <tr class="">
            ...
            <th nowrap align="center"><?=_("代考勤人员")?></th>
...
<br>
<div align="center">
    <input type="button" class="btn" value="<?=_("返回")?>" onClick="location='../index.php#agentSetting';">
</div>
<br>
</body>
</html>