...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_LICENSE where LICENSE_ID='$LICENSE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_LICENSE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where LICENSE_ID='$LICENSE_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?LICENSE_ID=$LICENSE_ID&?start=$start&connstatus=1");
?>
