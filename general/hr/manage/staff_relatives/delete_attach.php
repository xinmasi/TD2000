...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_RELATIVES where RELATIVES_ID='$RELATIVES_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_RELATIVES set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where RELATIVES_ID='$RELATIVES_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?RELATIVES_ID=$RELATIVES_ID&?start=$start");
?>
