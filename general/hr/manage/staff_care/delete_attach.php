...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_CARE where CARE_ID='$CARE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_CARE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where CARE_ID='$CARE_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?CARE_ID=$CARE_ID&?start=$start");
?>
