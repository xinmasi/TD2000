...
if($ROW=mysql_fetch_array($cursor))
{
    ...
    $BY_CARE_NAME1=substr(GetUserNameById($BY_CARE_STAFFS),0,-1);
    $SELECT_FLAG=0;
    if($BY_CARE_NAME1=="")
    {
        $SELECT_FLAG=1;
...
<form action="update.php"  method="post" name="form1" id="form1"  enctype="multipart/form-data" >
    <table class="TableBlock" width="80%" align="center">
        ...
        <tr>
            ...
            <td class="TableData">
                <input type="text" name="BY_CARE_NAME" size="17" class="BigStatic validate[required]" data-prompt-position="topRight:0,-8"  readonly value="<?=$BY_CARE_NAME1?>">&nbsp;
        ...
        <tr>
            ...
            <td class="TableData" colspan=3>
                ...
                <textarea cols=60 name="PARTICIPANTS_NAME" rows=2 class="BigStatic validate[required]" data-prompt-position="topRight:0,-8"  wrap="yes" readonly><?=$PARTICIPANTS_NAME?></textarea>
