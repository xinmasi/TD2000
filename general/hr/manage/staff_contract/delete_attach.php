...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_CONTRACT where CONTRACT_ID='$CONTRACT_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_CONTRACT set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where CONTRACT_ID='$CONTRACT_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?CONTRACT_ID=$CONTRACT_ID&?start=$start");
?>
