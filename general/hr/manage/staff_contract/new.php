...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
    ...
    <tr>
        <td><?= _("说明：1、合同试用日期应小于合同终止日期；2、合同解除日期应大于合同终止日期；3、合同续签日期应大于合同终止日期。") ?></td>
    </tr>
</table>
<br>
<form enctype="multipart/form-data" action="add.php"  method="post" name="form1" onSubmit="return CheckForm();">
    <table class="TableBlock" width="80%" align="center">
        <tr>
            ...
            <td class="TableData" >
                <INPUT type="text"  name="STAFF_CONTRACT_NO" class=BigInput size="11" value="<?=$STAFF_CONTRACT_NO?>" onBlur="check_no(this.value)" />&nbsp;<span id="byname_msg"></span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="TableData">
      	<span >
         <input type="text" id="start_time2" name="CONTRACT_EFFECTIVE_TIME" size="12" maxlength="10" class="BigInput" value="<?=$TRAIL_EFFECTIVE_TIME?>" onClick="WdatePicker({minDate:'#F{$dp.$D(\'start_time1\')}'})"/>
        </span>
            </td>
        </tr>
        ...
        <tr id="CONTRACT_END_DATE">
            ...
            <td class="TableData">
            <span>
             <input type="text" name="CONTRACT_END_DATE" size="12" maxlength="10" class="BigInput" value="<?=$PROBATION_END_DATE?>" onClick="WdatePicker({minDate:'#F{$dp.$D(\'start_time2\')}'})"/>
            </span>
            </td>
       ...
       <input type="text" name="CONTRACT_RENEW_TIME" size="12" maxlength="10" class="BigInput" value="<?=$CONTRACT_REMOVE_TIME?>" onClick="WdatePicker()"/>
        ...
        <tr>
            <td class="TableData" colspan=4>
                <?
                echo get_field_table(get_field_html("CONTRACT"));
                ?>
            </td>
        </tr>
