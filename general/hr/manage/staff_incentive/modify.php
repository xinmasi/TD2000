...
{
    AddImage2Editor('INCENTIVE_DESCRIPTION', src);
}
...
<form action="update.php"  method="post" name="form1" id="form1"  enctype="multipart/form-data"  >
 ...
 <tr>
      ...
      <input type="text" name="STAFF_NAME1" size="15" class="BigInput validate[required]" data-prompt-position="centerRight:0,-6" readonly value="<?=$STAFF_NAME1?>">&nbsp;
<? 
if($SELECT_FLAG==0) 
{ 
?>   
...
?>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="TableData">
       <INPUT type="text"name="SALARY_MONTH" class="BigInput validate[required]" data-prompt-position="centerRight:0,-6" size="8" value="<?=$SALARY_MONTH?>">
      </td>
    </tr>
