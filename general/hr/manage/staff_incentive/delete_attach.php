...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_INCENTIVE where INCENTIVE_ID='$INCENTIVE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_INCENTIVE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where INCENTIVE_ID='$INCENTIVE_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?INCENTIVE_ID=$INCENTIVE_ID&?start=$start");
?>
