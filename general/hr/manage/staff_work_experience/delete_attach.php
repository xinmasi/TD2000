...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_WORK_EXPERIENCE where W_EXPERIENCE_ID='$W_EXPERIENCE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_WORK_EXPERIENCE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where W_EXPERIENCE_ID='$W_EXPERIENCE_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?W_EXPERIENCE_ID=$W_EXPERIENCE_ID&?start=$start");
?>
