...
<tr>
      <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/sys_config.gif" WIDTH="18" HEIGHT="18" align="absmiddle"><span class="big3">&nbsp;<?=_("工作经历信息导入")?></span>
      </td>
</tr>
</table>
<br>
<table class="TableBlock" align="center" width="70%">  
 ...
 <tr class="TableData" align="center" height="30">
   ...
   <td width="400" align="left">
   	<a href="#" onClick="window.location='templet_export.php'"><?=_("工作经历信息导入模板下载")?></a>
   </td>
 </tr>
 <tr class="TableData" align="center" height="30">
 ...
 <tr class="TableData" align="center" height="30">
  ...
  <td align="left">
    ...
    <?=_("1、请导入.xls文件。")?>
    <br>
    <?=_("1、用户名，单位员工(OA中真实姓名)必须填写一个，否则不导入。")?>
    <br>
