...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/notify_open.gif" align="absmiddle"><span class="big3"> <?=_("工作经历管理")?></span>&nbsp;
    </td>
<?
if($TOTAL_ITEMS>0)
{
...
?>
   <tr class="TableControl">
     <td colspan="19">
       ...
       <a href="javascript:delete_mail();" title="<?=_("删除所选工作经历信息")?>"><img src="<?=MYOA_STATIC_SERVER?>/static/images/delete.gif" align="absMiddle"><?=_("删除")?></a>&nbsp; 
     </td>
   </tr>
<?
}else{
