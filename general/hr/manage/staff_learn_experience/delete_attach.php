...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_LEARN_EXPERIENCE where L_EXPERIENCE_ID='$L_EXPERIENCE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_LEARN_EXPERIENCE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where L_EXPERIENCE_ID='$L_EXPERIENCE_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?L_EXPERIENCE_ID=$L_EXPERIENCE_ID&?start=$start");
?>
