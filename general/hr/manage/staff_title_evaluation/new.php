...
<table class="TableBlock" width="80%" align="center">
   <tr>
      ...
      <td class="TableData">
        <input type="text" name="BY_EVALU_NAME" size="15" class="BigStatic" readonly value="<?=substr(GetUserNameById($BY_EVALU_STAFFS),0,-1)?>">&nbsp;
    ...
    <tr>
      ...
      <td class="TableData">
        <input type="text" id="start_time1" name="REPORT_TIME" size="15" maxlength="10" class="BigInput" value="<?=$REPORT_TIME?>" onClick="WdatePicker()"/>
      </td>
      <td nowrap class="TableData"> <?=_("获取时间：")?></td>
      <td class="TableData">
        <input type="text" name="RECEIVE_TIME" size="15" maxlength="10" class="BigInput" value="<?=$RECEIVE_TIME?>" onClick="WdatePicker({minDate:'#F{$dp.$D(\'start_time1\')}'})"/>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="TableData">
        <input type="text" id="start_time2" name="START_DATE" size="15" maxlength="10" class="BigInput" value="<?=$START_DATE?>" onClick="WdatePicker()"/>
      </td>
      <td nowrap class="TableData"><?=_("聘用结束时间：")?></td>
      <td class="TableData">
        <input type="text" name="END_DATE" size="15" maxlength="10" class="BigInput" value="<?=$END_DATE?>" onClick="WdatePicker({minDate:'#F{$dp.$D(\'start_time2\')}'})"/>
      </td>
    </tr>
     <tr id="EDITOR">
