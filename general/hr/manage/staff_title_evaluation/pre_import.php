...
<tr>
      <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/sys_config.gif" WIDTH="18" HEIGHT="18" align="absmiddle"><span class="big3">&nbsp;<?=_("职称评定信息导入")?></span>
      </td>
</tr>
</table>
<br>
<table class="TableBlock" align="center" width="70%">  
 ...
 <tr class="TableData" align="center" height="30">
   ...
   <td width="400" align="left">
   	<a href="#" onClick="window.location='templet_export.php'"><?=_("职称评定信息导入模板下载")?></a>
   </td>
 </tr>
 <tr class="TableData" align="center" height="30">
 ...
 <tr class="TableData" align="center" height="30">
  ...
  <td align="left">
    ...
    <?=_("1、请导入.xls文件。")?>
    <br>
    <?=_("2、评定对象的用户名和评定对象（OA中真实姓名）两项必须填写一项，否则不导入。")?>
    <br>
    <?=_("3、批准人（OA中真实姓名），获取职称两项不能为空，否则不导入。")?>
    <br>
