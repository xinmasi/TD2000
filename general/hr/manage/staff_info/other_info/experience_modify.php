...
<form action="experience_update.php"  method="post" name="form1" enctype="multipart/form-data"  onsubmit="return CheckForm();">
    ...
    <tr>
      ...
      <td class="TableData">
       <!--<INPUT type="text"name="DEGREE" class=BigInput size="15" value="<?=$DEGREE?>">-->
    	<select name="DEGREE" class="BigSelect" title="<?=_("在职状态可在“人力资源设置”->“HRMS代码设置”模块设置。")?>">
