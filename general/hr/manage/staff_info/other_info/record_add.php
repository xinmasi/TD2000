...
$query1= "SELECT * from  HR_TRAINING_RECORD WHERE 1='1' and STAFF_USER_ID='$STAFF_USER_ID_EACH' and T_PLAN_NO='$T_PLAN_NO' and STAFF_USER_ID = '$USER_ID'";
...
?>
<br><center><input type="button" value="<?=_("返回")?>" class="BigButton" onClick="location.href='record_new.php'"></center>
</body>
</html>
