...
if($SMS_REMIND=="on")
{
    ...
    send_sms($SEND_TIME,$_SESSION["LOGIN_USER_ID"],$REMAND_USERS,58,$SMS_CONTENT,$REMIND_URL,$INCENTIVE_ID);
...
<br><center><input type="button" value="<?=_("返回")?>" class="BigButton" onClick="location.href='incentive_new.php'"></center>
</body>
</html>
