...
if($TRAIL_PASS_OR_NOT==0 && $PASS_OR_NOT==1 && $REMOVE_OR_NOT==0 && $RENEW_OR_NOT==0)
{
...
$query="insert into  HR_STAFF_CONTRACT (
  CREATE_USER_ID,
  CREATE_DEPT_ID,
  STAFF_NAME,
  STAFF_USER_NAME,
...
?>
<center>
<input type="button" class="BigButton" value="<?=_("返回")?>" onclick="window.location.href='contract_new.php'"/>
</center>
</body>
</html>
