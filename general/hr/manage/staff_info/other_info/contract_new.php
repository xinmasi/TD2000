   ...
   <tr>
      ...
      <td class="TableData">
      	<?php 
      		...
      		$row=substr(GetUserNameById($user_id),0,-1);
      	?>
        <input type="text" name="STAFF_NAME1" size="12" class="BigStatic" readonly value="<?=$row?>">&nbsp;
        <input type="hidden" name="STAFF_NAME" value="<?=$user_id?>">
