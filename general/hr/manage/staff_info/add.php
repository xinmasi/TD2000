...
?>
<br><center><input type="button" value="<?=_("返回")?>" class="BigButton" onClick="location.href='new.php?DEPT_ID=<?=$DEPT_ID?>&SOURCE=new_hrms'"></center>
</body>
</html>
