...
$query="select a.*,b.DUTY_TYPE from HR_STAFF_INFO a
				LEFT OUTER JOIN USER_EXT b ON a.USER_ID=b.USER_ID
...
if($ROW=mysql_fetch_array($cursor))
{
   ...
   $ATTACHMENT_NAME=$ROW["ATTACHMENT_NAME"]; 	 
	 ...
	 $LAST_UPDATE_TIME=$ROW["LAST_UPDATE_TIME"];	
  	...
  	$WORK_LEVEL_NAME=get_hrms_code_name($WORK_LEVEL,"WORK_LEVEL");
  	$WORK_JOB_NAME=get_hrms_code_name($WORK_JOB,"POOL_POSITION");      
  	$query1 = "SELECT DUTY_NAME from ATTEND_CONFIG where DUTY_TYPE='".$DUTY_TYPE."'";
    $cursor1= exequery(TD::conn(),$query1);
    if($ROW1=mysql_fetch_array($cursor1))
    	$DUTY_TYPE_NAME=$ROW1["DUTY_NAME"];
...
$sql    = "SELECT BYNAME FROM user WHERE USER_ID = '$USER_ID'";
$cursor1 = exequery(TD::conn(),$sql);
$arr    = mysql_fetch_array($cursor1);
...
?>
  ...
  <tr>
    ...
    <td nowrap align="left" class="TableData" width="180"><?=$STAFF_NO?></td>  
  ...
  <tr>
    ...
    <td class="TableData" width="180"><?=$STAFF_NAME?></td>  	
...
?>
  ...
  <tr>
    ...
    <td class="TableData" width="180"><?=$STAFF_AGE?></td>
  ...
  <tr>
    ...
    <td class="TableData"  width="180"><?=$WORK_LEVEL_NAME?></td>
    <td nowrap align="left" class="TableContent"><?=_("岗位：")?></td>
    <td class="TableData"  width="180"><?=$WORK_JOB_NAME?></td>
    <td nowrap align="left" class="TableContent"><?=_("考勤排班类型：")?></td>
    <td class="TableData"  width="180"><?=$DUTY_TYPE_NAME?></td>                 
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="TableData"  width="180"><?=$WORK_STATUS_NAME?></td>               
  </tr>
  <tr>
...
<tr>
  ...
  <tr>
    ...
    <td class="TableData"  width="180"><?=$STAFF_MAJOR?></td>
