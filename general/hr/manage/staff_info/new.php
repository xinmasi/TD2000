...
function check_user(id)
{
    ...
    _get("check_user.php","BYNAME="+id, show_msg_user);
}

function show_msg_user(req)
{
    if(req.status==200)
    {
...
<table class="TableBlock" width="770" align="center">
    ...
    <tr>
        ...
        <td class="TableData" width="180" <? if(!($YES_OTHER==1)) echo "colspan=4"; ?>>
            <input type="text" name="BYNAME" id="BYNAME" class="BigIput" size="10" maxlength="20" data-prompt-position="centerRight:-4,-10" onBlur="check_user(this.value)">&nbsp;<span id="byname_msg" name="byname_msg"></span>&nbsp;&nbsp;&nbsp;<span id="chek_card_id" style="color: red; font-weight: bold;"></span>
        </td>
<?
if($YES_OTHER==1)
{
...
?>
    ...
    <tr>
        ...
        <td class="TableData" width="180"><input type="text" name="DEPT_NAME" id="DEPT_NAME" class="BigStatic" value="<?=$DEPT_NAME?>" readonly></td>
...
<?
$query = "SELECT * from USER_PRIV WHERE 1=1 order by PRIV_NO desc";
...
?>
    ...
    <tr>
        ...
        <td class="TableData" width="180"><input type="text" name="STAFF_NO" id="STAFF_NO" class="BigInput"  onBlur="check_no(this.value)" ></td>
    ...
    <tr>
        ...
        <td class="TableData" colspan="2" title="<?=_("填写完身份证号码后可直接生成")?>"><input type="text" name="STAFF_AGE" id="STAFF_AGE" size="4" class="BigInput"><?=_("岁")?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="TableData"  ><input type="text" name="STAFF_HEALTH" id="STAFF_HEALTH" class="BigInput"></td>
        <td nowrap class="TableData" width="100"><?=_("年休假：")?></td>
        <td class="TableData" colspan="3"><input type="text" name="LEAVE_TYPE" size="3" maxlength="4" class="BigInput" value="<?=$LEAVE_TYPE?>"><?=_("天")?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="TableData" width="180" colspan="3"><input type="text" name="STAFF_DOMICILE_PLACE" id="STAFF_DOMICILE_PLACE" size="40" class="BigInput"></td>
    </tr>
    <tr>
<?
if($PHOTO_NAME=="")
...
?>
    ...
    <tr>
        ...
        <td class="TableData"  width="180"><input type="text" name="JOB_AGE" id="JOB_AGE" class="BigStatic" readonly></td>
...
?>
    ...
    <tr align="center" class="TableControl">
        <td colspan=6 nowrap>
            ...
            <input type="button" value="<?=_("保存")?>" class="BigButton" onClick="CheckForm();" id="sub">
