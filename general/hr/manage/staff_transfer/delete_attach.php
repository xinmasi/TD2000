...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_TRANSFER where TRANSFER_ID='$TRANSFER_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_TRANSFER set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where TRANSFER_ID='$TRANSFER_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?TRANSFER_ID=$TRANSFER_ID&?start=$start");
?>
