...
$TMP_ARRAY = explode(",",trim($DEPT_HR_MANAGER1,','));
...
if($role != "")
{
    ...
    $query="UPDATE user SET USER_PRIV='$role',USER_PRIV_NO='$PRIV_NO',USER_PRIV_NAME='$PRIV_NAME' WHERE USER_ID = '$TRANSFER_PERSON'";
    exequery(TD::conn(),$query);
}
...
header("location:index1.php?TRANSFER_ID=$TRANSFER_ID&connstatus=1")
