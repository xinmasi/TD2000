...
{
	LEAVE_PERSON = document.form1.REINSTATEMENT_PERSON.value;
  URL="user_select_single/?FUNC_ID="+FUNC_ID+"&MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&MANAGE_FLAG="+MANAGE_FLAG+"&FORM_NAME="+FORM_NAME+"&LEAVE_PERSON="+LEAVE_PERSON;
  loc_y=loc_x=200;
  if(is_ie)
  {
...
<table class="TableBlock" width="80%" align="center">
   <tr>
      ...
      <td class="TableData">
        <input type="text" name="REINSTATEMENT_PERSON_NAME" size="15" class="BigStatic" readonly value="<?=substr(GetUserNameById($USER_ID),0,-1)?>">&nbsp;
        <input type="hidden" name="REINSTATEMENT_PERSON" value="<?=$USER_ID?>">
        <a href="javascript:;" class="orgAdd" onClick="selectuser('27','','REINSTATEMENT_PERSON', 'REINSTATEMENT_PERSON_NAME')"><?=_("选择")?></a>
      </td>
