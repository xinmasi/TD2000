...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_REINSTATEMENT where REINSTATEMENT_ID='$REINSTATEMENT_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_REINSTATEMENT set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where REINSTATEMENT_ID='$REINSTATEMENT_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?REINSTATEMENT_ID=$REINSTATEMENT_ID&?start=$start");
?>
