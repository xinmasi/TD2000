...
function CheckForm()
{
   ...
   if(document.form1.ABILITY_NAME.value==""|| pattern.test(document.form1.ABILITY_NAME.value))
   { 
      alert("<?=_("技能名称不能为空！")?>");
      return (false);
   }
   ...
   if(isNaN(document.form1.EXPIRES.value))
   { 
      alert("<?=_("有效期只能是数值！")?>");
      return (false);
   }
   ...
   if(document.form1.ISSUE_DATE.value!="" && document.form1.EXPIRE_DATE.value!="" && document.form1.ISSUE_DATE.value > document.form1.EXPIRE_DATE.value)
   { 
...
<table class="TableBlock" width="80%" align="center">
   <tr>
    ...
    <tr>
      ...
      <td class="TableData">
       <input type="text" name="ISSUE_DATE" size="15" maxlength="10" id="start_time" class="BigInput" value="<?=$ISSUE_DATE?>" onClick="WdatePicker()"/>
      </td>
    </tr>
    <tr>
