...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_LABOR_SKILLS where SKILLS_ID='$SKILLS_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_LABOR_SKILLS set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where SKILLS_ID='$SKILLS_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?SKILLS_ID=$SKILLS_ID&?start=$start");
?>
