...
{
   $query = "SELECT count(*) from HR_STAFF_LABOR_SKILLS where ".$WHERE_STR;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/notify_open.gif" align="absmiddle"><span class="big3"> <?=_("管理劳动技能")?></span>&nbsp;
    </td>
<?
if($TOTAL_ITEMS>0)
{
...
$query = "SELECT * from HR_STAFF_LABOR_SKILLS where ".$WHERE_STR." order by ADD_TIME desc limit $PAGE_START, $PAGE_SIZE";
$cursor= exequery(TD::conn(),$query, $connstatus);
$SKILLS_COUNT=0;
