...
<?
$query="select ATTACHMENT_ID,ATTACHMENT_NAME from HR_STAFF_LEAVE where LEAVE_ID='$LEAVE_ID'";
...
if($ATTACHMENT_NAME!="")
{
   ...
   $query="update HR_STAFF_LEAVE set ATTACHMENT_ID='$ATTACHMENT_ID',ATTACHMENT_NAME='$ATTACHMENT_NAME' where LEAVE_ID='$LEAVE_ID'";
   exequery(TD::conn(),$query);
}
header("location: modify.php?LEAVE_ID=$LEAVE_ID&?start=$start");
?>
