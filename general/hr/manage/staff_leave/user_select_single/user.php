...
if($MODULE_ID=="2")
 ...
 {
    $query = "SELECT UID,USER_ID,DEPT_ID,USER_NAME,DEPT_ID from USER,USER_PRIV where USER.USER_PRIV='$USER_PRIV' and DEPT_ID!=0 and USER.USER_PRIV=USER_PRIV.USER_PRIV";
    if(!$MANAGE_FLAG)
       $query .= " and NOT_LOGIN='0'";
    if($DEPT_PRIV=="3"||$DEPT_PRIV=="4")
      $query .= " and find_in_set(USER.USER_ID,'$USER_ID_STR')";
