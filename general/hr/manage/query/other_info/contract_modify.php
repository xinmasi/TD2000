...
<body class="bodycolor" topmargin="5">
    ...
    <br>
<!--    <div>说明：</div>-->
    <form enctype="multipart/form-data" action="contract_update.php"  method="post" name="form1" onSubmit="return CheckForm();">
        <table class="TableBlock" width="80%" align="center">
            <tr>
                ...
                <td class="TableData" >
                    <INPUT type="text"name="STAFF_CONTRACT_NO" class=BigInput size="11" value="<?= $STAFF_CONTRACT_NO ?>" onblur="check_no(this.value,<?=$CONTRACT_ID?>)" >
                </td>
            </tr>
...
<?= hrms_code_list("HR_STAFF_CONTRACT1", $CONTRACT_TYPE) ?>
            ...
            <tr>
                ...
                <td class="TableData">
                    <span >
                        <input type="text" name="CONTRACT_EFFECTIVE_TIME" size="12" maxlength="10" class="BigInput" value="<?= $PROBATION_EFFECTIVE_DATE ?>" onClick="WdatePicker()"/>
                    </span>
                </td>
            </tr>
            ...
            <tr id="CONTRACT_END_DATE">
                ...
                <td class="TableData">
                    <span>
                        <input type="text" name="CONTRACT_END_DATE" size="12" maxlength="10" class="BigInput" value="<?= $CONTRACT_END_TIME ?>" onClick="WdatePicker()"/>
                    </span>
                </td>
