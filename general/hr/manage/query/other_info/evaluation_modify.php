...
if($ROW=mysql_fetch_array($cursor))
{
    ...
    $BY_EVALU_NAME=GetUserNameById($ROW["BY_EVALU_STAFFS"]);
...
<form action="evaluation_update.php"  method="post" name="form1" enctype="multipart/form-data" onSubmit="return CheckForm();">
