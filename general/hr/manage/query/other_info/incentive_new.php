...
<br>
<form enctype="multipart/form-data" action="incentive_add.php"  method="post" name="form1" onSubmit="return CheckForm();">
    <table class="TableBlock" width="80%" align="center">
        <tr>
            ...
            <td class="TableData" colspan=3>
                <?
                $STAFF_NAME =$USER_ID.",";
                $STAFF_NAME1 = getUserNameById($USER_ID);
                ?>
                <input type="hidden" name="STAFF_NAME" value="<?=$STAFF_NAME?>">
                <textarea cols=45 name="STAFF_NAME1" rows=2 class="BigStatic" wrap="yes" readonly><?=_("$STAFF_NAME1")?></textarea>
        ...
        <tr>
            ...
            <td class="TableData">
                <INPUT type="text"name="SALARY_MONTH" class=BigInput size="8" value="<?=$CUR_MONTH?>">
            </td>
        </tr>
