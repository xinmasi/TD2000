...
{
   $query = "SELECT count(*) from HR_STAFF_INCENTIVE where STAFF_NAME='".$_SESSION["LOGIN_USER_ID"]."'";
...
$query = "SELECT * from HR_STAFF_INCENTIVE where STAFF_NAME='".$_SESSION["LOGIN_USER_ID"]."' order by ADD_TIME desc limit $PAGE_START, $PAGE_SIZE";
$cursor= exequery(TD::conn(),$query);
$INCENTIVE_COUNT=0;
