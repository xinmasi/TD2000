...
<table class="TableList"  width="100%">
  ...
  <tr class="TableControl">
    <td align="center" colspan=7>
    	<input type="button"  value="<?=_("查看上下班登记详情")?>" class="SmallButton" onClick="location='attendance_user_shift.php?USER_ID=<?=$USER_ID?>&DATE1=<?=$DATE1?>&DATE2=<?=$DATE2?>'">
    </td>
  </tr>
</table>
...
<div align="center">
  <input type="button"  value="<?=_("返回")?>" class="BigButton" onClick="location='attendance_list.php?USER_ID=<?=$USER_ID?>';">
</div>
</body>
</html>
