...
{
   $query = "SELECT count(*) from HR_STAFF_CARE where BY_CARE_STAFFS='".$_SESSION["LOGIN_USER_ID"]."' ";
...
$query = "SELECT * from HR_STAFF_CARE where BY_CARE_STAFFS='".$_SESSION["LOGIN_USER_ID"]."' order by CARE_DATE desc limit $PAGE_START, $PAGE_SIZE";
$cursor= exequery(TD::conn(),$query);
$CARE_COUNT=0;
