...
{
   $query = "SELECT count(*) from SAL_FLOW where ISSEND='0'";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/salary.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> <?=_("（财务工资录入）待办流程")?></span>
    </td>
<? 
if($TOTAL_ITEMS>0)
{
...
?>
    <tr class="TableData">
      ...
      <br><a href="import.php?FLOW_ID=<?=$FLOW_ID?>&PAGE_START=<?=$PAGE_START?>"> <?=_("导入")?>EXCEL<?=_("工资数据")?></a></td>
    </tr>
<?
 }
