...
while($ROW=mysql_fetch_array($cursor))
{
 ...
 if($$OPERATION_ID==1)
 {
  $query1="insert into SAL_DATA(FLOW_ID,USER_ID,IS_FINA_INPUT";
  ...
  $query1.=",REPORT) values ('".$FLOW_ID."','$USER_ID','1',";
...
header("location:table.php?FLOW_ID=$FLOW_ID&DEPT_ID=$DEPT_ID");
?>
</body>
</html>
