...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/salary.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> <?=sprintf(_("薪酬基数设置（%s）"), $USER_NAME)?></span>
    </td>
  </tr>
</table>
...
?>
    <tr class="TableData">
      ...
      <td nowrap align="left">
         <input type="hidden" name="<?=$S_NAME?>" value="<?=isset($ITEM_NAME)? $ITEM_NAME:"0.00";?>">
...
<table width="450" class="TableList">
  ...
  <tr class="TableData">
    ...
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="ALL_BASE" class="BigInputMoney" name="ALL_BASE" value="<?=isset($ALL_BASE)? $ALL_BASE:"0.00";?>" size="20" maxlength="14">
  ...
  <tr class="TableLine1">
    ...
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="PENSION_BASE" class="BigInputMoney" name="PENSION_BASE" value="<?=isset($PENSION_BASE)? $PENSION_BASE:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>
  <tr class="TableLine1" >
    <td nowrap align="center" width="150"><?=_("单位养老")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="PENSION_U" class="BigInputMoney" name="PENSION_U" value="<?=isset($PENSION_U)? $PENSION_U:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>
  <tr class="TableLine1" > 
    <td nowrap align="center" width="150"><?=_("个人养老")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="PENSION_P" class="BigInputMoney" name="PENSION_P" value="<?=isset($PENSION_P)? $PENSION_P:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("医疗保险")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="MEDICAL_BASE" class="BigInputMoney" name="MEDICAL_BASE" value="<?=isset($MEDICAL_BASE)? $MEDICAL_BASE:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("单位医疗")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="MEDICAL_U" class="BigInputMoney" name="MEDICAL_U" value="<?=isset($MEDICAL_U)? $MEDICAL_U:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("个人医疗")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="MEDICAL_P" class="BigInputMoney" name="MEDICAL_P" value="<?=isset($MEDICAL_P)? $MEDICAL_P:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>
  <tr class="TableLine1">
    <td nowrap align="center" width="150"><?=_("生育保险")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="FERTILITY_BASE" class="BigInputMoney" name="FERTILITY_BASE" value="<?=isset($FERTILITY_BASE)? $FERTILITY_BASE:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>    
  <tr class="TableLine1">
    <td nowrap align="center" width="150"><?=_("单位生育")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="FERTILITY_U" class="BigInputMoney" name="FERTILITY_U" value="<?=isset($FERTILITY_U)? $FERTILITY_U:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("失业保险")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="UNEMPLOYMENT_BASE" class="BigInputMoney" name="UNEMPLOYMENT_BASE" value="<?=isset($UNEMPLOYMENT_BASE)? $UNEMPLOYMENT_BASE:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("单位失业")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="UNEMPLOYMENT_U" class="BigInputMoney" name="UNEMPLOYMENT_U" value="<?=isset($UNEMPLOYMENT_U)? $UNEMPLOYMENT_U:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("个人失业")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="UNEMPLOYMENT_P" class="BigInputMoney" name="UNEMPLOYMENT_P" value="<?=isset($UNEMPLOYMENT_P)? $UNEMPLOYMENT_P:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>      
  <tr class="TableLine1">
    <td nowrap align="center" width="150"><?=_("工伤保险")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="INJURIES_BASE" class="BigInputMoney" name="INJURIES_BASE" value="<?=isset($INJURIES_BASE)? $INJURIES_BASE:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>      
  <tr class="TableLine1">
    <td nowrap align="center" width="150"><?=_("单位工伤")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="INJURIES_U" class="BigInputMoney" name="INJURIES_U" value="<?=isset($INJURIES_U)? $INJURIES_U:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>      
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("住房公积金")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="HOUSING_BASE" class="BigInputMoney" name="HOUSING_BASE" value="<?=isset($HOUSING_BASE)? $HOUSING_BASE:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>      
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("单位住房")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="HOUSING_U" class="BigInputMoney" name="HOUSING_U" value="<?=isset($HOUSING_U)? $HOUSING_U:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150"><?=_("个人住房")?></td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="HOUSING_P" class="BigInputMoney" name="HOUSING_P" value="<?=isset($HOUSING_P)? $HOUSING_P:"0.00";?>" size="20" maxlength="14">
    </td>
  </tr>   
</table>             
<?
...
?>
    <tr class="TableData">
      ...
      <td nowrap align="left">
        ...
        <input type="text" name="<?=$S_ID?>"  size="20" maxlength="14" class="BigInputMoney" value="<?=isset($$S_ID)? $$S_ID:"0.00";?>">
