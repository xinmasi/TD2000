...
if($START_DATE!="")
   $CONDITION_STR.=" and BEGIN_DATE>='$START_DATE'";
if($END_DATE!="")
   $CONDITION_STR.=" and END_DATE<='$END_DATE'";  
if($DEPT_FLAG!=1)
{
...
<?
   $query1="select * from SAL_DATA,SAL_FLOW where SAL_DATA.FLOW_ID=SAL_FLOW.FLOW_ID and SAL_DATA.FLOW_ID='$FLOW_ID' and USER_ID='$USER_ID'".$CONDITION_STR;
   $cursor1= exequery(TD::conn(),$query1);
   if($ROW=mysql_fetch_array($cursor1))
   {
      for($I=0;$I< $COUNT;$I++)
