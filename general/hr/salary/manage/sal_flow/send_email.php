...
<form name="form1" method="post" action="email_result.php">
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<?=MYOA_STATIC_SERVER?>/static/images/menu/email.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">&nbsp;&nbsp;EMAIL<?=_("工资条")?> (<?= $CONTENT ?>)</span>
   </td>
  </tr>
</table>
<br>
...
<table class="TableBlock" align="center" >
  <tr>
    ...
    <td nowrap class="TableData">
        ...
        <a href="javascript:;" class="orgClear" onClick="ClearUser('COPY_TO_ID', 'COPY_TO_NAME')"><?=_("清空")?></a><br />&nbsp;<img src="<?=MYOA_STATIC_SERVER?>/static/images/attention.gif" height="16" title="<?=_("提示")?>"><?=_("人员为空时发送全部人员的工资条")?>
    </td>
  </tr>
  <tr>
  <tr>
    <td nowrap class="TableContent">&nbsp;&nbsp;<?=_("选项：")?> </td>
    <td nowrap class="TableData">
        <input type="checkbox" name="ZERO" id="ZERO"><label for="ZERO"><?=_("不显示数额为零的项目")?></label>
    </td>
  </tr>
  <tr>
...
?>
  ...
  <tfoot align="center" class="TableFooter">
    <td nowrap colspan="4" align="center">
       ...
       <input type="button" value="<?=_("返回")?>" class="BigButton"  onClick="javascript:location='index.php?FLOW_ID=<?=$FLOW_ID?>&PAGE_START=<?=$PAGE_START?>'">
    </td>
   </tfoot>
</table>
</div>
