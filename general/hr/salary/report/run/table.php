...
<form action="table_submit.php"  method="post" name="form1" onSubmit="return CheckForm();">
...
//============================ 显示已定义用户 =======================================
 ...
 $query8 = "SELECT * from USER,USER_PRIV where DEPT_ID='$DEPT_ID' and USER.USER_PRIV=USER_PRIV.USER_PRIV order by PRIV_NO,USER_NO,USER_NAME";
