  ...
  <form name="form1" method="post" action="import_submit.php?FLOW_ID=<?=$FLOW_ID?>" enctype="multipart/form-data" onSubmit="return CheckForm();">
    <tr class="TableData" align="center" height="30">
     ...
     <td width="400" align="left">
  	  <a href="#" onClick="window.location='templet_export.php'"><?=_("部门上报工资导入模板下载")?></a>
     </td>
   </tr>
    <tr class="TableData" align="center" height="30">
   ...
   <tr class="TableData" align="center" height="30">
 	 	...
 	 	<td width="400" align="left">
  		<input type="checkbox" name="compute" id="Id_compute" value="1" ><label for="Id_compute"><?=_("导入的同时计算所有的计算项")?></label>&nbsp;&nbsp;<span class='red' style='font-size:6px'>[注:此项只有在项目类型全是部门录入的时候选中]</span>
  		</td>
   </tr>
   <tr class="TableData" align="center" height="30">
    ...
    <?=_("1、请上传.xls文件；")?>
    <br>
    <?=_("2、使用部门上报工资导入模板的列顺序为用户名、姓名、上报工资项目；")?>
    <br>
    <?=_("3、部门上报工资导入模板中姓名不能为空，为空则不能导入；")?>
    </span>
    </td>
   </tr>
<?
