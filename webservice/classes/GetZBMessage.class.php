...
class GetZBMessage {
    ...
    private function __retMsg($retCode) {
        ...
        return iconv(MYOA_CHARSET,"utf-8",$retMsg);
    }
	...
	public function recvSms($UNIT_NAME) {
	    ...
	    $UNIT_NAME=iconv("utf-8",MYOA_CHARSET,$UNIT_NAME);  
		...
		while($ROW = mysql_fetch_array($cursor))
		{
		   ...
		   $SMS_ARRAY[$SMS_INDEX]["FROM_NAME"]=iconv(MYOA_CHARSET,"utf-8",$FROM_NAME);
		   $SMS_ARRAY[$SMS_INDEX]["SMS_TYPE"]=$SMS_TYPE;
		   $SMS_ARRAY[$SMS_INDEX]["CONTENT"]=iconv(MYOA_CHARSET,"utf-8",$CONTENT);
		   $SMS_ARRAY[$SMS_INDEX]["SEND_TIME"]=$SEND_TIME;
		   $SMS_ARRAY[$SMS_INDEX]["REMIND_URL"]=$REMIND_URL;
		   $SMS_ARRAY[$SMS_INDEX]["TO_ID"]=iconv(MYOA_CHARSET,"utf-8",$FZ_USER);
