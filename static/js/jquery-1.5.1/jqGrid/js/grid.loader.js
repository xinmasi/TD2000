...
{
    var pathtojsfiles = "/static/js/jquery-1.5.1/jqGrid/js/"; // need to be ajusted
    var gzfix = '';
    //for grid.loader.js.gz
    //var gzfix = userAgent.match(/safari/gi) || (window.console && console.OaSms) ? '' : '.gz';  
