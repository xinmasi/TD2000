...
(function($){
   $(document).ready(function(){
      var rows = $('tr.TableLine1, tr.TableLine2');
      rows.hover(
      ...
      rows.click(function(){
         ...
         checkbox.checked = $(this).attr('class').indexOf('TableRowActive') > 0;
      ...
      $('#allbox').click(function(){
         ...
         $('tr.TableLine1, tr.TableLine2').each(function(){
            var active = $(this).attr('class').indexOf('TableRowActive') > 0;
