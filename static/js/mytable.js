...
{
   $("module_"+module_id+"_ul").innerHTML="<div style='text-align:center;'><img src='/static/images/loading.gif' align='absMiddle'> 加载中，请稍候……</div>";
   var xmlHttpObj=getXMLHttpObj();
   ...
   xmlHttpObj.onreadystatechange=function()
	{
	 	if(xmlHttpObj.readyState==4)
	 	{
	 		if(xmlHttpObj.status==200)
	 		   ...
	 		   $("module_"+module_id+"_ul").innerHTML=td_lang.inc.msg_103+xmlHttpObj.status;//"更新内容错误，代码："
	 	}
	}
   xmlHttpObj.send(null)
}
