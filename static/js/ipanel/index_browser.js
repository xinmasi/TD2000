...
function send_sms(TO_UID,TO_NAME)
{
   ...
   var myleft=0;
   window.open("/general/status_bar/sms_back.php?TO_UID="+TO_UID+"&TO_NAME="+escape(TO_NAME),"","height=310,width=450,status=0,toolbar=no,menubar=no,location=no,scrollbars=no,top="+mytop+",left="+myleft+",resizable=yes");
}
function group_send_sms(TO_UID,TO_NAME)
{
   var mytop=screen.availHeight-350;
   var myleft=0;
   window.open("/general/status_bar/sms_back.php?TO_UID="+TO_UID+"&TO_NAME="+escape(TO_NAME)+"&C=Web","","height=310,width=450,status=0,toolbar=no,menubar=no,location=no,scrollbars=no,top="+mytop+",left="+myleft+",resizable=yes");
}
function send_sms1(MSG_ID)
{
   var mytop=screen.availHeight-350;
   var myleft=0;
   window.open("/general/status_bar/sms_back.php?MSG_ID="+MSG_ID+"&MSG_FW=1","","height=310,width=450,status=0,toolbar=no,menubar=no,location=no,scrollbars=no,top="+mytop+",left="+myleft+",resizable=yes");
}
...
function history_sms(MSG_ID)
{
   ...
   var myleft=0;
   window.open("/general/sms/msg_center/history_sms.php?MSG_ID="+MSG_ID,MSG_ID,"height=310,width=370,status=0,toolbar=no,menubar=no,location=no,scrollbars=no,top="+mytop+",left="+myleft+",resizable=yes");
}
...
function send_weixun(note_id)
{
    var mytop=screen.availHeight-350;
    var myleft=0;
    window.open("/general/status_bar/sms_back.php?NOTE_ID="+note_id,"","height=310,width=450,status=0,toolbar=no,menubar=no,location=no,scrollbars=no,top="+mytop+",left="+myleft+",resizable=yes");
}
