    ...
    var TImageUploadCtrl = Base.extend({
        ...
        addimages: function(fileinfo){
            ...
            $.each(fileinfo, function(k, file){
                ...
                self.$list.empty().append('<a href="javascript:void(0);" data-attach_id="'+file.id+'" data-attach_name="'+name+'" class="pda_attach pda_attach_img" is_image="1" _href="'+file.url+'"><img src="'+file.url+'" /><span class="fileupload-item icon-delete">×</span></a>');
            });
        },
        uploadImages: function() {
            ...
            if(platform == "wx" || platform=="qywx"){
                ...
                window.image_upload_ctrl(function(info){
                    if(platform == "client"){
                        self.addimages(info);
                    }else if(platform == "dd"){
