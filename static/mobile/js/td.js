...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.getLocationByMap = exports.getMacAddress = exports.checkIn = exports.closeWebview = exports.actionSheet = exports.setLeft = exports.setRight = exports.setTitle = exports.selectDept = exports.selectUser = exports.selectAttachment = exports.selectPic = exports.getNetworkType = exports.sendMessage = exports.callPhone = exports.showAttachment = exports.startApp = exports.showPic = exports.getLocation = exports.showToast = exports.showDialog = undefined;
	...
	var selectUser = exports.selectUser = function selectUser(bridge) {
		return function (argObj) {
			...
			try {
				bridge.callHandler(_constants.SELECT_USER, { ids: users.join(), multiple: multiple, usableUids: usableUids, checkedAll: checkedAll }, function (responseData) {
					responseData = JSON.parse(responseData);
