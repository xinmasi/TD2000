...
function delete_list(model_id,flow_id,t_id)
{
	...
	{
		var url = "/general/system/approve_center/flow_guide/flow_type/set_timer/del_schema.php?DELETE_STR="+ delete_str + "&FLOW_ID="+flow_id;
	}else if(model_id == "manage"){ //管理权限
		var url = "/general/system/approve_center/flow_guide/flow_type/set_manage/delete.php?DELETE_STR="+ delete_str + "&FLOW_ID="+flow_id;
		...
		var url = "/general/system/approve_center/flow_guide/flow_type/set_print/delete.php?DELETE_STR="+ delete_str + "&FLOW_ID="+flow_id;
	}
