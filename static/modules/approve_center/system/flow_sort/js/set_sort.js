	...
	if(sort_id=='0'){
		jQuery.post('form/check_name.php',{'sort_name':sort_name,'sort_parent':sort_parent},function(data){
			if(data=='1'){
				...
				jQuery.post('form/save.php',{'sort_parent':sort_parent,'sort_no':sort_no,'sort_name':sort_name,'dept_id':dept_id,'form_dept_id_old':form_dept_id_old},function(data){
					if(data!=='0'){
						jQuery('#table_form').load('form/index.php',function(){});
		...
		if(old_name!==sort_name){
			jQuery.post('form/check_name.php',{'sort_name':sort_name,'sort_parent':sort_parent},function(data){
				if(data=='1'){
					...
					jQuery.post('form/save.php',{'sort_parent':sort_parent,'sort_no':sort_no,'sort_name':sort_name,'dept_id':dept_id,'sort_id':sort_id,'have_child':have_child,'form_parent':sort_old_parent,'form_dept_id_old':form_dept_id_old},function(data){
						jQuery('#table_form').load('form/index.php',function(){});
