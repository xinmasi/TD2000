            ...
            var contentManage = {
                            ...
                            if(e.node.original.is_new=='1'){
                                ...
                                if(e.node.original.priv=='1'){
                                    ...
                                    if(e.node.original.source=='0'){
                                        console.log(e.node.original.source);
                ...
                contentRender:function(type){
                    ...
                    switch(type){
                        ...
                        break;
                        case '3':
                            type_article_int.attr('checked',true);content_text_box.addClass('hide');attachment_box.removeClass('hide');link_box.addClass('hide');type_article.addClass('hide');type_link_column.addClass('hide');type_link_out.addClass('hide');type_imgs.addClass('hide');type_video.removeClass('hide');open_way.addClass('hide');
                        break;
                        default:
                ...
                contentChange:function(value){
                    ...
                    switch(value){
                        ...
                        break;
                        case '3':
                            contentBox.addClass('hide');attachment_box.removeClass('hide');linkBox.addClass('hide');column_tree.addClass('hide');open_way.addClass('hide');
                        break;
                        default:
                            return ;
                    }
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            if(res.status == '1'){
                                ...
                                res.data.download == '0'?$('input[name=download]').attr('checked',false):$('input[name=download]').attr('checked',true);
                            }else{
                                alert('获取编辑数据失败');
                            }
