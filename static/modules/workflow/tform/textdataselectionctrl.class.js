    ...
    var TExtDataSelectionCtrl = Base.extend({
        ...
        initialize: function(config) {
            ...
            el.click(function(){
                	...
                	var URL="/general/workflow/list/input_form/data_picker_link.php?dataSrc="+dataSrc+"&data_control="+data_control+"&dataSrcName="+dataSrcName+"&datadbid="+datadbid+"&datawidth="+datawidth+"&datahigth="+datahigth+"&dataField="+dataField+"&dataFieldName="+dataFieldName+"&item_str="+map_name_str+"&type=ext_data&objName="+el.get(0).name+"&dataQuery="+dataQuery;
                	var openWidth = 800;
                    var openHeight = 450;
