...
{
    var url = '/general/workflow/new/edit.php?FLOW_ID=' + flow_id;
    if(edit_str != "")
    {
...
function view_form(FLOW_ID,FORM_ID)
{
    ...
    window.open("/general/workflow/form_view.php?FORM_ID="+FORM_ID,"form_view","status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=600,left="+myleft+",top=50");
}
function show_explanation(FLOW_ID)
{
     ...
     */
    window.open('/general/workflow/new/show_explan.php?flow_id='+FLOW_ID,'sss','width=700,height=400,left=200,top=200,toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1');
}
...
function to_old_new_work()
{
    ...
    window.location="/general/workflow/new/new_old/index.php";
}